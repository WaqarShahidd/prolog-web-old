export const partners = [
  ...
  {
    id: 5,
    image: require("../assets/images/partner.jpg"),
    link: "https://tradecouncil.org/",
  },
  {
    id: 6,
...
export const membersOf = [
  {
    id: 1,
    image: require("../assets/images/CIFFA.png"),
    link: "https://www.ciffa.com",
  },
  {
    id: 2,
    image: require("../assets/images/itc2.jpg"),
...
export const testimonials = [
  ...
  },
  {
    ...
    designation: "Overseas | Mehan Tondar Bar - Tehran ",
  ...
  },
  {
    ...
    designation: "General Manager - Mehan Tondar Bar - Tehran ",
    logo: require("../assets/images/mehan.png"),
    flag: "https://upload.wikimedia.org/wikipedia/commons/c/ca/Flag_of_Iran.svg",
  },
  {
  ...
  },
  {
    ...
    designation: "Coordinator-Business Development - Marvel Freight Ltd. Dhaka",
...
export const aboutUs = [
  {
    ...
    title: "About Us",
    subtitle:
      "Professional Logistics Network (ProLog ) is a professionally managed independent international freight management and logistics platform only for the independent forwarders who thrive for sheer excellence and have professional work ethics. ProLog was founded with the sole idea to unite Professional Freight Forwarders across the globe and bring them on par with multinationals. Unlike the usual one time document verification - We ensure that our members keep their updated documents on file for both - their own recordkeeping as well as for the benefit of other members who are selectively able to ascertain the continued credibility of their partners. This exercise ensures our members are always assured that they are working with the best.",
  },
  {
    id: 2,
    title: "What sets us apart",
    subtitle:
      "Membership to be listed as a directory member is absolutely free* - for life. It is said, nothing is ever free. But your Basic membership to ProLog is. When you get the feel of what we claim is true - you are now ready to  move to the next level - which will now open up a plethora of benefits - unparalleled benefits of what a true networking should stand for. Our starting point is where the biggest is just getting into. We work backwards - by giving you the best first and saving the rest for the last. Our benefits section will enumerate all that is presently available and whats coming.",
  },
